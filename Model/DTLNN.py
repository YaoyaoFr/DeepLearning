...
class DeepTransferLearningNN(NeuralNetwork):
    ...
    def __init__(self,
        ...
        self.auto_encoders = [
            layer for layer in self.op_layers if 'AE' in layer.pa['scope']]
    ...
    def training(self,
        ...
        with self.graph.as_default():
            ...
            fine_tune_data = {'train data': data['train data'],
            ...
            early_stop = self.backpropagation(data=fine_tune_data,
                                              early_stop=early_stop)
